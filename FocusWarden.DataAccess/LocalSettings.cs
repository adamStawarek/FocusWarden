namespace FocusWarden.DataAccess
{
    ...
    public sealed class LocalSettings : ApplicationSettingsBase, IDataSettings
    {
        ...
        public DataSet<FocusSession> FocusSessions
        {
            get
            {
                if (!(this["FocusSessions"] is DataSet<FocusSession>))
                {
                    this["FocusSessions"] = new DataSet<FocusSession>();
                }

                return (DataSet<FocusSession>)this["FocusSessions"];
            }
            set => this["FocusSessions"] = value;
        }
        ...
        public DataSet<TodoItem> TodoItems
        {
            get
            {
                if (!(this["TodoItems"] is DataSet<TodoItem>))
                {
                    this["TodoItems"] = new DataSet<TodoItem>();
                }
        ...
        public TimeSpan SessionDuration
        {
            get
            {
                if (!(this["SessionDuration"] is TimeSpan))
                {
                    this["SessionDuration"] = TimeSpan.FromMinutes(25);
                }
        ...
        {
            ((ApplicationSettingsBase)this).Save();
        }
    }
}